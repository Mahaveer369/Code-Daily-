    ...
    <div className="rounded-xl overflow-hidden border border-gray-700 bg-[#0d1117] shadow-2xl mt-8">
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-[#161b22] border-b border-gray-700">
        ...
        <button
          onClick={handleRun}
          disabled={isRunning}
          className={`flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-bold transition-all ${isRunning ? 'bg-gray-700 text-gray-400' : 'bg-green-600 hover:bg-green-500 text-white'
            }`}
        >
          {isRunning ? (
