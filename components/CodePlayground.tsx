      ...
      <div className="flex items-center justify-between px-4 py-3 bg-[#161b22] border-b border-gray-700">
        <div className="flex items-center gap-2">
          <div className="flex gap-1.5">
            <button
              className="w-3 h-3 rounded-full bg-red-500/70 hover:bg-red-500 cursor-pointer transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-1 focus-visible:ring-offset-[#161b22]"
              onClick={handleReset}
              title="Reset Code"
              aria-label="Reset Code"
            ></button>
            <button
              className="w-3 h-3 rounded-full bg-yellow-500/70 hover:bg-yellow-500 cursor-pointer transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-1 focus-visible:ring-offset-[#161b22]"
              onClick={handleClear}
              title="Clear Output"
              aria-label="Clear Output"
            ></button>
            <button
              className="w-3 h-3 rounded-full bg-green-500/70 hover:bg-green-500 cursor-pointer transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-1 focus-visible:ring-offset-[#161b22]"
              onClick={handleRun}
              title="Run Code"
              aria-label="Run Code"
            ></button>
