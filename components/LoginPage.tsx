    ...
    <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-2xl border border-gray-700/50 rounded-3xl p-8 shadow-2xl relative z-10 animate-fadeIn">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="email" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 cursor-pointer">Email Address</label>
            <input
              id="email"
              type="email"
              required
          ...
          <div>
            <label htmlFor="password" className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2 cursor-pointer">Password</label>
            <input
              id="password"
              type="password"
              required
